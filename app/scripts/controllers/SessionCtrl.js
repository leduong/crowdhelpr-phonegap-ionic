...
controller('SessionCtrl', function($rootScope, $ionicPush, $scope, User, countryCode, $ionicPopup, $localStorage, $state, $ionicLoading, $ionicHistory, $ionicNavBarDelegate) {
  $scope.data = {};
  var user = new User();
  ...
  $scope.sendCode = function(data) {
    user.sendPhoneCode(data).then(function(res) {
