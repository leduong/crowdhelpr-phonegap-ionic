...
factory('Feeds', ['$http', '$q', '$localStorage', '$ionicLoading', '$state', 'User', 'FeedService', function($http, $q, $localStorage, $ionicLoading, $state, User, FeedService) {
  var Feed = function() {
    this.busy = false;
    this.perpage = 3;
  ...
  Feed.prototype.destroy = function(eventid) {
    if (this.busy) {
      return;
    }
    this.busy = true;
