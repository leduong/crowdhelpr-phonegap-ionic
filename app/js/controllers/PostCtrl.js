...
controller('PostCtrl', [
  '$scope', '$cordovaCamera', '$cordovaImagePicker', '$ionicLoading', '$localStorage', '$ionicHistory', '$ionicActionSheet', 'Feeds', '$ionicPopup',
  function($scope, $cordovaCamera, $cordovaImagePicker, $ionicLoading, $localStorage, $ionicHistory, $ionicActionSheet, Feeds, $ionicPopup) {
