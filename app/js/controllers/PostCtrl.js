...
// controller('PostCtrl', [
//   '$scope', '$cordovaCamera', '$cordovaImagePicker', '$ionicLoading', '$localStorage', '$ionicHistory', 'Feeds', '$ionicPopup',
//   function($scope, $cordovaCamera, $cordovaImagePicker, $ionicLoading, $localStorage, $ionicHistory, Feeds, $ionicPopup) {
